...
echo "Execution time for cs was `expr $end - $start` seconds.">> timer.txt
...
echo "Execution time for cm was `expr $end - $start` seconds.">> timer.txt
...
echo "Execution time for ca was `expr $end - $start` seconds.">> timer.txt
